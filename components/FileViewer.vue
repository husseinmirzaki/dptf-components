<template>
  <card
    ...
    <template v-slot:card-content>
      <div class="file-label" v-if="fileData.field && fileData.field.label"> {{ fileData.field.label }} </div>
      <img class="type-icon z-index-0" :src="'/media/icons/type-icons/' + type +'.png' "/>
