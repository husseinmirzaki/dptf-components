    ...
    _defineConverters() {                                                      // ADDED
        ...
        conversion.for('editingDowncast').elementToElement({
            ...
            view: (modelElement, {writer: viewWriter}) => {
                const span = viewWriter.createContainerElement('span', {class: 'letter-reference'});
        ...
        conversion.for('editingDowncast').elementToElement({
            model: 'letter-number',
            view: (modelElement, {writer: viewWriter}) => {
                const span = viewWriter.createContainerElement('u', {class: 'letter-reference-underline'});
