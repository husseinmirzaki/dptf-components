<template>
  <div class="position-relative">
    <input :readonly="readonly" :placeholder="$attrs.placeholder"  class="form-control mb-2"
           v-model="inputValue"/>
    <div class="position-absolute d-flex align-items-center justify-content-center" @click="$refs.mapModal.open()" style="height:42px;left: 1px; top: 0">
      <span class="svg-icon svg-icon-1">
      <inline-svg src="media/icons/duotune/maps/map008.svg"/>
    </span>
    </div>
  </div>
  <Modal ref="mapModal" modal-body-class-extra="p-0" :thin-footer="true" modal-title="انتخاب از نقشه">
...
import Modal from "@/custom/components/model/Modal";

export default {
  components: {Modal, LTileLayer, LMap, LMarker},
  props: {
    'name': String,
    'readonly': Boolean,
    "modelValue": {
