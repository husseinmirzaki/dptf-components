...
function icon(props: any) {
  ...
  return h("span", props, h(InlineSvg, { src: props["src"] }));
}
...
function dropDownButtonWarp(props: any) {
  ...
  if (!props["data-kt-menu-trigger"]) props["data-kt-menu-trigger"] = "click";

  if (!props["data-kt-menu-placement"])
    props["data-kt-menu-placement"] = "bottom-start";

  if (!props["data-kt-menu-flip"]) props["data-kt-menu-flip"] = "top-end";

  return props;
}

export const DEFAULT_BUTTONS = {
  default: (props: any, children: any, type = "") =>
    button(props, children, type),
  primary: (props: any, children: any) =>
    DEFAULT_BUTTONS.default(props, children, "btn-primary"),
  secondary: (props: any, children: any) =>
    DEFAULT_BUTTONS.default(props, children, "btn-secondary"),
  danger: (props: any, children: any) =>
    DEFAULT_BUTTONS.default(props, children, "btn-danger"),
  success: (props: any, children: any) =>
    DEFAULT_BUTTONS.default(props, children, "btn-success"),
...
export const DROPDOWN_BUTTONS = {
  default: (props: any, children: any) =>
    button(dropDownButtonWarp(props), children, ""),
  primary: (props: any, children: any) =>
    button(dropDownButtonWarp(props), children, "btn-primary"),
  secondary: (props: any, children: any) =>
    button(dropDownButtonWarp(props), children, "btn-secondary"),
  icon: (buttonProps: any, iconProps: any) => {
...
function col(options, children) {
  return h("div", Object.assign({}, options), children);
}

function row(options, children) {
  return h("div", Object.assign({ class: "row" }, options), children);
}
